...
import { HomeTalentSearchDialog } from "@/components/talent/home-talent-search-dialog";
...
export default async function HomePage() {
  ...
  return (
    <PageWrapper
      ...
      description="A focused workspace to submit profiles, explore approved professionals, and run role-based operations without friction."
    >
